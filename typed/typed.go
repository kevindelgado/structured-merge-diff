...
func (tv TypedValue) RemoveItems(items *fieldpath.Set) *TypedValue {
	tv.value = combinedRemoveItemsWithSchema(tv.value, items, tv.schema, tv.typeRef, false)
...
func (tv TypedValue) ExtractItems(items *fieldpath.Set) *TypedValue {
	//tv.value = combinedRemoveItemsWithSchema(tv.value, items, tv.schema, tv.typeRef, true)
